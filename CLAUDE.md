...
- **Siempre** que se modifique algo en `main/models.py` (tablas, columnas, tipos, claves, restricciones o relaciones), revisar si hay que actualizar el diagrama entidad-relación físico en `docs/diagrama_entidad_relacion.mmd` y dejarlo en sincronía con los modelos.
